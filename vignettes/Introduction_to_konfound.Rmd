...
Finally, you can return the raw output, useful for use in other analyses. 
...
Here, `d` represents output from a number (9 in this illustrative case) of past studies.
