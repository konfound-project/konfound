...
if (requireNamespace("htmltools", quietly = TRUE)) {
  ...
  if (index == "IT") { 
    ...
    cat("\n")
    cat("Frank, K. (2000). Impact of a confounding variable on the inference of a regression coefficient.")
    cat("\n")
    cat(crayon::italic("Sociological Methods and Research, 29"), "(2), 147-194")
    cat("\n")
    cat("\n")
    cat("Accuracy of results increases with the number of decimals reported.")
    cat("\n")
