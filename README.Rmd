...
change RoC for non-0 hypothesis

"Replacement of Cases Approach"
"Correlation-Based Approach"

"change omitted variable to "defined as the product of the correlation between the omitted variable and the predictor of interest and the correlation between the omitted variable and the outcome as in Frank"

Frank, 2000

conditional on Z

round beat threshold

remove RoC and correlalation inference

make y-axis continuous 

histogram of percent bias to invalidate the inference
one plot to sustain the inference
one plot to invalidate

link here: https://msu.edu/~kenfrank/research.htm#causal
