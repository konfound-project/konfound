...
test_that("tkonfound creates the correlation plot when switch_trm = FALSE", {
    ...
    tkonfound_fig2 <-  tkonfound_fig(35, 17, 17, 38, thr_p = 0.01, switch_trm = FALSE)[[3]]
...
test_that("tkonfound creates the correlation plot with test = chisq", {
    ...
    tkonfound_fig3 <- tkonfound_fig(35, 17, 17, 38, thr_p = 0.01, switch_trm = TRUE, test = "chisq")[[3]]
...
test_that("tkonfound creates the correlation plot with test = chisq and replace = entire", {
    ...
    tkonfound_fig4 <- tkonfound_fig(35, 17, 17, 38, thr_p = 0.01, switch_trm = TRUE, test = "chisq", replace = "entire")[[3]]
...
test_that("tkonfound creates the correlation plot when treatment is small", {
    ...
    tkonfound_fig5 <- tkonfound_fig(10, 17, 17, 10, thr_p = 0.01, switch_trm = TRUE, test = "chisq", replace = "entire")[[3]]
