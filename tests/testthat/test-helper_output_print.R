...
test_that("output_print produces the correct language when index is 'RIR' with eff_thr specified", {
    ...
    expected_lines <- c(
        ...
        "To nullify the inference based on your estimate, 30% of the",
        "estimate of 0.6 would have to be due to bias. This implies that to nullify",
...
test_that("output_print produces the correct language for 'TO SUSTAIN' when index is 'RIR' with eff_thr specified", {
    ...
    expected_lines <- c(
        ...
        "To reach that threshold, 20% of the estimate of 0.3 would have to be due",
