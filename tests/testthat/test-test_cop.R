...
test_that("test_cop outputs the correct language and values when to_return is 'print'", {
    ...
    expected_lines <- c(
        ...
        "",
        "Background ",
        "This function calculates a correlation-based coefficient of proportionality",
        "(delta_Correlation) along with Oster's delta*. The correlation-based COP",
        "does not depend on the specification of a baseline model.",
        "",
        "COP ",
        ...
        "for statistical significance is 1.578. This requires a CV (omitted confounder) ",
        "with partial correlations r_xcv|z ~ 0.8350 (between X and CV given Z) and",
        "r_ycv|z ~ 0.4260 (between Y and CV given Z).",
        "",
        "Using the delta threshold for statistical significance and the corresponding ",
        "partial correlations, the coefficient of X in the final model will be 0.3591",
